...
if (isset($_POST['themth'])) {
  ...
  if (empty($tenth)) {
    ...
    <?php
      ...
      $sqlth = "INSERT INTO `tbl_thuonghieu`(`thuonghieu`) VALUES ('$tenth')";
      $sql_themsp = mysqli_query($con, $sqlth);
      ?>
      <script>
        setTimeout(function() {
          swal("Success!",'Thêm thương hiệu thành công !', "success").then(()=>{
...
<head>
  ...
  <title>Admin | Thêm thương hiệu</title>
        ...
        <section class="content" style="margin:30px">
              ...
              <div class="card card-primary">
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" id="inputName" class="form-control" name="tenth" value="">
                  </div>
          ...
          <!-- <div class="col-1"></div> -->
            <div class="col-12">
              ...
              <input type="submit" value="Thêm thương hiệu" class="btn btn-success float-right" name="themth">
            </div>
            <!-- <div class="col-1"></div> -->
          </div>
        </section>
