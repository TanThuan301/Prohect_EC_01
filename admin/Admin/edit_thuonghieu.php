...
if (isset($_POST['suath'])) {
  ...
  if (empty($tenth)) {
    ...
    <?php
        ...
        $sql_suath = "UPDATE `tbl_thuonghieu` SET `thuonghieu`='$tenth' WHERE ID='$id_th_sua'";
       
      mysqli_query($con, $sql_suath);
    ?>
      <script>
        setTimeout(function() {
          swal("Success!", 'Cập nhật thương hiệu thành công !', "success").then(() => {
        ...
        <section class="content" style="margin:30px">
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                <?php
                $id_th_edit = $_GET['id_edit_th'];
                $sql_select_th_edit = mysqli_query($con, "SELECT * FROM tbl_thuonghieu WHERE ID='$id_th_edit'");
                $row_select_th_edit = mysqli_fetch_array($sql_select_th_edit);

                ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputName">Tên thương hiệu</label>
                    <input type="text" id="inputName" class="form-control" name="tenth" value="<?php echo $row_select_th_edit['thuonghieu'] ?>">
                  </div>
                </div>
                <!-- /.card-body -->
              </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input type="submit" value="Sửa thương hiệu" class="btn btn-success float-right" name="suath">
            </div>
          </div>
        </section>
      </form>
