...
if (isset($_POST['suach'])) {
  ...
  if (empty($ram)||empty($cpu)||empty($ocung)||empty($manhinh)) {
    ...
    <?php
        ...
        $sql_suath = "UPDATE `tbl_cauhinh` SET `CPU`='$cpu',`RAM`='$ram',`OCUNG`='$ocung',`MANHINH`='$manhinh'  WHERE ID='$id_ch_sua'";
       
      mysqli_query($con, $sql_suath);
    ?>
      <script>
        setTimeout(function() {
          swal("Success!", 'Cập nhật cấu hình thành công !', "success").then(() => {
        ...
        <section class="content" style="margin:30px">
          <div class="row">
            <div class="col-md-12">
              <div class="card card-primary">
                <?php
                $id_ch_edit = $_GET['id_edit_ch'];
                $sql_select_ch_edit = mysqli_query($con, "SELECT * FROM tbl_cauhinh WHERE ID='$id_ch_edit'");
                $row_select_ch_edit = mysqli_fetch_array($sql_select_ch_edit);

                ?>
                <div class="card-body">
                  <div class="form-group">
                    <label for="inputName">CPU</label>
                    <input type="text" id="inputCPU" class="form-control" name="CPU" value="<?php echo $row_select_ch_edit['CPU']?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputRAM" class="form-control" name="RAM" value="<?php echo $row_select_ch_edit['RAM']?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputOCUNG" class="form-control" name="OCUNG" value="<?php echo $row_select_ch_edit['OCUNG']?>">
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="inputMH" class="form-control" name="MANHINH" value="<?php echo $row_select_ch_edit['MANHINH']?>">
                  </div>
          ...
          <div class="row">
            <div class="col-12">
              ...
              <input type="submit" value="Sửa cấu hình" class="btn btn-success float-right" name="suach">
            </div>
          </div>
        </section>
      </form>
