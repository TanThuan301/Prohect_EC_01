  ...
  <div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
      ...
      <a href="" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Admin LapTop Strore</span>
      </a>
    ...
    <?php
    $sql_sp=mysqli_query($con, "select * from tbl_sanpham");
    $sql = mysqli_query($con, "select * from tbl_donhang");
    $sql_gd = mysqli_query($con, "select * from tbl_giaodich,tbl_sanpham where tbl_giaodich.id_sanpham=tbl_sanpham.id_sp");
    $i = 0;
    $soluong = 0;
    while ($row_tk = mysqli_fetch_array($sql)) {
      $i++;
      $soluong += $row_tk['soluong'];
    }
    $tongtien = 0;
    $tongsp=0;
    while ($row_gd = mysqli_fetch_array($sql_gd)) {
      $gia = str_replace('.', '', $row_gd['giakhuyenmaisp']);
      $tongtien += $gia * $row_gd['soluong'];
    }
    while ( $row_sql_sp = mysqli_fetch_array( $sql_sp)) {
      
      $tongsp+=$row_sql_sp['soluongsp'];
    }
          ...
          <div class="row">
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-success">
                <div class="inner">
                  <h3><?php echo $tongsp?><sup style="font-size: 20px"></sup></h3>
            ...
            <div class="col-lg-3 col-6">
              ...
              <div class="small-box bg-danger">
                <div class="inner">
                  <h3><?php echo number_format($tongtien) . 'VNĐ' ?></h3>
